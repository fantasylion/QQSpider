...
class InitMessages(object):
    ...
    def __init__(self):
        ...
        self.db = pymongo.MongoClient('65.49.204.74', 27017)['QQ']
        self.rconn = redis.Redis('localhost', 6379, charset="utf-8", decode_responses=True)  # 存放种子和Cookie
    ...
    def readMyQQ(self, file_dir="./myQQ.txt"):
        ...
        cookieNum = ''.join(list(self.rconn.keys())).count('Cookies')
        if cookieNum == 0:
